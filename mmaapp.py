...
with tab1:
     ...
     if user_name == '현역병입영대상' :
          ...
          with st.expander('🧑🏾‍🤝‍🧑🏽 당해연도 본인선택'):
               ...
               st.markdown("""<div style="background-color:#efefef;padding:4px;border:1px solid red;margin-bottom:15px">19세(07년생) 병역판정검사 수검자는 올해 하반기 당해연도 본인선택 접수 예정(5월이후)<br> 일정확정시 병무청 누리집 공지 및 알림톡 발송</div>""", unsafe_allow_html=True) 
...
st.markdown('**강원지방병무청** (_Updated on 2026. 5. 13._)')
